...
class GetStartedActivity : AppCompatActivity() {
    ...
    private fun storeUserDetails(userId: String, name: String, email: String, contactNumber: String, country: String, city: String) {
        val user = hashMapOf(
            ...
            "country" to country,
            "city" to city,
            "profilePhoto" to "", // Start with an empty string or default URL
            "profileCover" to "", // Start with an empty string or default URL
        ...
        firestore.collection("users").document(userId)
            ...
            .addOnSuccessListener {
                ...
                // Example booking data. In a real app, this would be dynamically generated based on user action.
                val exampleBooking = hashMapOf(
                    "mentorDocumentId" to "exampleMentorId",
                    "date" to "2024-03-22", // Example date, should be replaced with the actual date
                    "time" to "14:00" // Example time, should be replaced with the actual time
                )

                // Add a new booking document with a unique ID generated by Firestore
                firestore.collection("users").document(userId).collection("bookings")
                    .add(exampleBooking)

                // Example review data. Similarly, this would be dynamically generated.
                val exampleReview = hashMapOf(
                    "mentorName" to "exampleMentorName",
                    "experience" to "This was a great session!",
                    "rating" to 5 // Example rating
                )
                // Add a new review document with a unique ID generated by Firestore
